...
public class ReviewController extends HttpServlet {
    ...
    public void init() throws ServletException {
        try {
            reviewDAO = DIContainer.get(ReviewDAO.class);
    ...
    private void createReview(HttpServletRequest request, HttpServletResponse response)
        ...
        // Validate rating range (already validated by getValidatedIntParameter, but
        // double-check)
    ...
    private void deleteReview(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer reviewId = utils.SecurityUtil.getValidatedIntParameter(request, "reviewId", 1, Integer.MAX_VALUE);
        boolean isStaff = "staff".equalsIgnoreCase(currentUser.getRole()) ||
                "admin".equalsIgnoreCase(currentUser.getRole());
