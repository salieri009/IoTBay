                ...
                <div class="max-w-6xl mx-auto">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="${pageContext.request.contextPath}/manage/products/form" class="btn btn--primary">Add Product</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <c:choose>
                                ...
                                <c:forEach var="product" items="${products}">
                                    <div class="card p-6 hover-lift">
                                        <div class="flex items-start justify-between mb-4">
                                            ...
                                            <span class="badge ${product.stockQuantity > 0 ? 'badge--success' : 'badge--warning'}">
                                                ${product.stockQuantity > 0 ? 'Active' : 'Out of Stock'}
                                            </span>
                                        </div>
                                        
                                        <h3 class="text-lg font-semibold text-neutral-900 mb-2">${product.name}</h3>
                                        <p class="text-sm text-neutral-600 mb-4 line-clamp-2">${product.description != null ? product.description : 'No description available'}</p>
                                        ...
                                        <div class="space-y-2 mb-4">
                                            ...
                                            <div class="flex justify-between text-sm">
                                                ...
                                                <span class="font-medium text-neutral-900">${product.categoryId}</span>
                                            </div>
                                        </div>
                            ...
                            <c:otherwise>
                                <div class="col-span-full text-center py-12">
                                    <p class="text-neutral-600">No products found.</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
