        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            <%@ page import="model.User" %>
                ...
                <% User user=(User) session.getAttribute("user"); if (user==null ||
                    ...
                    <t:base title="Add Product | IoT Bay">
                        <main class="flex-1">
                                ...
                                <div class="container">
                                    <div class="max-w-3xl mx-auto">
                                        ...
                                        <div class="bg-white p-8 rounded-xl shadow-sm border border-neutral-200">
                                            ...
                                            <% } %>
                                            <form action="${pageContext.request.contextPath}/api/manage/products"
                                                method="post">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                                    <div class="col-span-2">
                                                        <label
                                                            class="block text-sm font-medium text-neutral-700 mb-1">Product
                                                            Name *</label>
                                                        <input type="text" name="name" required
                                                            class="form-input w-full" placeholder="e.g. Smart Home Hub">
                                                    </div>

                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-neutral-700 mb-1">Category
                                                            ID *</label>
                                                        <input type="number" name="categoryId" required min="1"
                                                            class="form-input w-full" placeholder="1">
                                                    </div>

                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-neutral-700 mb-1">Price
                                                            *</label>
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-neutral-700 mb-1">Stock
                                                            Quantity *</label>
                                                    ...
                                                    <div class="col-span-2">
                                                        <label
                                                            class="block text-sm font-medium text-neutral-700 mb-1">Image
                                                            URL</label>
