                        ...
                        <div class="bg-white rounded-xl border border-neutral-200 p-6 shadow-sm space-y-6">
                            ...
                            <form action="${pageContext.request.contextPath}/cart/add" method="post" class="space-y-4">
                                ...
                                <c:if test="${!pd_inStock}">
                                    <div class="mt-4 p-3 bg-warning-50 border border-warning-200 rounded-lg" role="alert">
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-warning-800">Out of Stock</p>
                                                <p class="text-sm text-warning-700 mt-1">This item is currently unavailable. <a href="#" class="underline">Notify me when available</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </c:if>
