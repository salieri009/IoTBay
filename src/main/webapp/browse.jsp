                ...
                <nav class="breadcrumb mb-4" aria-label="Breadcrumb">
                    <ol class="breadcrumb__list">
                        <li class="breadcrumb__item">
                            <a href="${pageContext.request.contextPath}/" class="breadcrumb__link">Home</a>
                        </li>
                        <% if (category != null) { %>
                            <li class="breadcrumb__item">
                                <a href="${pageContext.request.contextPath}/categories" class="breadcrumb__link">Categories</a>
                            </li>
