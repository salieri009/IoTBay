                                    ...
                                    <t:base title="Warehouse Management Solutions - IoT Bay"
                                            ...
                                            <div class="container">
                                                <div class="hero__content">
                                                    ...
                                                    <p class="hero__subtitle">
                                                        Revolutionize your warehouse operations with intelligent
                                                        automation, real-time inventory tracking,
                                                        and data-driven logistics optimization for maximum efficiency
                                                        and cost savings.
                                                    </p>
                                                ...
                                                <div class="hero__image">
                                                    <img src="${pageContext.request.contextPath}/images/warehouse-hero.jpg"
                                                        alt="Smart Warehouse Management" class="hero__image"
                                        ...
                                        <main class="container py-16">
                                            ...
                                            <section class="mb-16">
                                                <div class="text-center mb-12">
                                                    <h2 class="text-display-sm font-bold text-neutral-900 mb-4">
                                                        Transform Your Warehouse Operations</h2>
                                                    <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                                                        Achieve operational excellence with our comprehensive warehouse
                                                        IoT solutions designed to optimize every aspect of your
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">95%
                                                            Accuracy</h3>
                                                        <p class="text-neutral-600 text-sm">Real-time inventory tracking
                                                            with RFID and barcode scanning</p>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">40%
                                                            Faster</h3>
                                                        <p class="text-neutral-600 text-sm">Automated workflows and
                                                            optimized picking routes</p>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">99.8%
                                                            Uptime</h3>
                                                        <p class="text-neutral-600 text-sm">Predictive maintenance and
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">30% Cost
                                                            Savings</h3>
                                                        <p class="text-neutral-600 text-sm">Reduced labor costs and
                                                            optimized space utilization</p>
                                                    </div>
                                                </div>
                                            </section>
                                            ...
                                            <section id="capabilities" class="mb-16">
                                                <div class="text-center mb-12">
                                                    <h2 class="text-display-sm font-bold text-neutral-900 mb-4">
                                                        Comprehensive Warehouse Capabilities</h2>
                                                    <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                                                        From inventory management to automated fulfillment, our
                                                        solutions cover every aspect of modern warehouse operations.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <p class="text-neutral-600 mb-4">
                                                                Track every item with precision using RFID tags, barcode
                                                                scanners, and automated counting systems.
                                                            </p>
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">
                                                                Smart Picking Systems</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Optimize order fulfillment with AI-powered route
                                                                optimization and automated picking guidance.
                                                            </p>
                                                            <ul class="space-y-2 text-sm text-neutral-700">
                                                                <li class="flex items-center gap-2">
                                                                    <svg class="w-4 h-4 text-success"
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <p class="text-neutral-600 mb-4">
                                                                Maintain optimal storage conditions with intelligent
                                            ...
                                            <section id="products" class="mb-8">
                                                <div
                                                    ...
                                                    <div>
                                                        <h2 class="text-2xl font-bold text-neutral-900 mb-2">Warehouse
                                                            Management Products</h2>
                                                        <p class="text-neutral-600">Discover our complete range of
                                                            warehouse automation solutions</p>
                                                    </div>
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="mb-8">
                                                        <h2 class="text-display-sm font-bold text-neutral-900 mb-2">
                                                            Warehouse Management Products</h2>
                                                        <p class="text-lg text-neutral-600">Discover our complete range
                                                            of warehouse automation solutions designed for efficiency
                                                            and accuracy</p>
                                                    </div>
                                                            ...
                                                            <div class="product-grid" id="products-grid">
                                                                <c:forEach var="p" items="${products}">
                                                                    <div class="product-card" data-product-id="${p.id}"
                                                                        ...
                                                                        data-category="warehouse" tabindex="0"
                                                            ...
                                                            <div class="empty-state text-center py-16">
                                                                ...
                                                                <p
                                                                    ...
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            There are no warehouse products available at
                                            ...
                                            <section class="mb-16">
                                                <div class="text-center mb-12">
                                                    <h2 class="text-display-sm font-bold text-neutral-900 mb-4">Success
                                                        Stories</h2>
                                                    <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                                                        See how leading companies have transformed their warehouse
                                                        operations with our IoT solutions.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                                    <div class="card">
                                                        <div class="card__body text-center">
                                                            <div class="text-3xl font-bold text-brand-primary mb-2">75%
                                                            </div>
                                                            <div class="text-lg font-semibold text-neutral-900 mb-2">
                                                                Faster Processing</div>
                                                            <p class="text-sm text-neutral-600">Global Electronics
                                                                reduced order processing time with automated picking
                                                                systems</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card__body text-center">
                                                            ...
                                                            <p class="text-sm text-neutral-600">Fashion Forward achieved
                                                                near-perfect inventory tracking with RFID implementation
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card__body text-center">
                                                            <div class="text-3xl font-bold text-brand-primary mb-2">$2M
                                                            </div>
                                                            <div class="text-lg font-semibold text-neutral-900 mb-2">
                                                                Annual Savings</div>
                                                            <p class="text-sm text-neutral-600">MegaDistributor saved
                                                                millions through optimized operations and reduced errors
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- Call to Action -->
                                            <section
                                                class="card bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                                                <div class="card__body text-center py-16">
                                                    <h2 class="text-3xl font-bold mb-4">Ready to Optimize Your
                                                        Warehouse?</h2>
                                                    <p class="text-xl mb-8 opacity-90">
                                                        Get a free consultation and see how our warehouse IoT solutions
                                                    ...
                                                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/browse"
                                                            class="btn btn--outline btn--lg border-white text-white hover:bg-white hover:text-indigo-600">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
