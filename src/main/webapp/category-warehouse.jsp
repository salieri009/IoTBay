...
<t:base title="Warehouse Management Solutions - IoT Bay" description="Optimize your warehouse operations with IoT solutions for inventory, automation, logistics.">
    ...
    <section class="hero bg-gradient-to-r from-blue-50 to-indigo-100">
        <div class="container">
            ...
            <div class="hero__image">
                <img src="<%=request.getContextPath()%>/images/warehouse-hero.jpg" 
                     alt="Smart Warehouse Management" 
                     class="hero__image"
                     onerror="this.src='<%=request.getContextPath()%>/images/sample2.png'">
            </div>
        </div>
    </section>
    ...
    <main class="container py-16">
        ...
        <section id="products" class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <div class="relative">
                        <form action="<%=request.getContextPath()%>/category-warehouse.jsp" method="get" class="flex">
                            <input type="text" 
                                   name="search" 
        ...
        <section class="product-grid mb-16" id="productsGrid">
            <!-- Demo products for warehouse management -->
            <div class="product-card" data-category="tracking" data-price="399">
                <img src="<%=request.getContextPath()%>/images/sample1.png" 
                     alt="RFID Inventory Tracking System" 
                     class="product-card__image">
                <div class="product-card__body">
                    <h3 class="product-card__title">RFID Inventory Tracking System</h3>
                    <p class="product-card__description">
                        Complete RFID solution for real-time inventory tracking with cloud-based analytics dashboard.
                    </p>
                    <div class="product-card__price">$399.99</div>
                    <div class="product-card__actions">
                        <a href="<%=request.getContextPath()%>/productDetails.jsp?id=7" class="btn btn--outline btn--sm">
                            View Details
                        </a>
                        <button onclick="addToCart(7)" class="btn btn--primary btn--sm">
                            Add to Cart
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card" data-category="automation" data-price="1599">
                <img src="<%=request.getContextPath()%>/images/sample2.png" 
                     alt="Automated Picking Robot" 
                     class="product-card__image">
                <div class="product-card__body">
                    <h3 class="product-card__title">Automated Picking Robot</h3>
                    <p class="product-card__description">
                        AI-powered robotic picking system for high-speed order fulfillment and reduced labor costs.
                    </p>
                    <div class="product-card__price">$1,599.99</div>
                    <div class="product-card__actions">
                        <a href="<%=request.getContextPath()%>/productDetails.jsp?id=8" class="btn btn--outline btn--sm">
                            View Details
                        </a>
                        <button onclick="addToCart(8)" class="btn btn--primary btn--sm">
                            Add to Cart
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card" data-category="monitoring" data-price="249">
                <img src="<%=request.getContextPath()%>/images/sample3.png" 
                     alt="Warehouse Environmental Sensor" 
                     class="product-card__image">
                <div class="product-card__body">
                    <h3 class="product-card__title">Environmental Monitoring Hub</h3>
                    <p class="product-card__description">
                        Multi-sensor hub for monitoring temperature, humidity, and air quality in storage areas.
                    </p>
                    <div class="product-card__price">$249.99</div>
                    <div class="product-card__actions">
                        <a href="<%=request.getContextPath()%>/productDetails.jsp?id=9" class="btn btn--outline btn--sm">
                            View Details
                        </a>
                        <button onclick="addToCart(9)" class="btn btn--primary btn--sm">
                            Add to Cart
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card" data-category="picking" data-price="699">
                <img src="<%=request.getContextPath()%>/images/sample1.png" 
                     alt="Smart Picking Guidance System" 
                     class="product-card__image">
                <div class="product-card__body">
                    <h3 class="product-card__title">Smart Picking Guidance System</h3>
                    <p class="product-card__description">
                        Voice-directed picking system with LED lights and barcode verification for error-free fulfillment.
                    </p>
                    <div class="product-card__price">$699.99</div>
                    <div class="product-card__actions">
                        <a href="<%=request.getContextPath()%>/productDetails.jsp?id=10" class="btn btn--outline btn--sm">
                            View Details
                        </a>
                        <button onclick="addToCart(10)" class="btn btn--primary btn--sm">
                            Add to Cart
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card" data-category="tracking" data-price="129">
                <img src="<%=request.getContextPath()%>/images/sample2.png" 
                     alt="Barcode Scanner Pro" 
                     class="product-card__image">
                <div class="product-card__body">
                    <h3 class="product-card__title">Wireless Barcode Scanner Pro</h3>
                    <p class="product-card__description">
                        High-performance wireless scanner with long-range capabilities and rugged design.
                    </p>
                    <div class="product-card__price">$129.99</div>
                    <div class="product-card__actions">
                        <a href="<%=request.getContextPath()%>/productDetails.jsp?id=11" class="btn btn--outline btn--sm">
                            View Details
                        </a>
                        <button onclick="addToCart(11)" class="btn btn--primary btn--sm">
                            Add to Cart
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card" data-category="automation" data-price="2999">
                <img src="<%=request.getContextPath()%>/images/sample3.png" 
                     alt="Conveyor Control System" 
                     class="product-card__image">
                <div class="product-card__body">
                    <h3 class="product-card__title">Smart Conveyor Control System</h3>
                    <p class="product-card__description">
                        Intelligent conveyor management with dynamic routing and real-time package tracking.
                    </p>
                    <div class="product-card__price">$2,999.99</div>
                    <div class="product-card__actions">
                        <a href="<%=request.getContextPath()%>/productDetails.jsp?id=12" class="btn btn--outline btn--sm">
                            View Details
                        </a>
                        <button onclick="addToCart(12)" class="btn btn--primary btn--sm">
                            Add to Cart
                        </button>
                    </div>
                </div>
        ...
        <section class="card bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
            <div class="card__body text-center py-16">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<%=request.getContextPath()%>/browse" class="btn btn--outline btn--lg border-white text-white hover:bg-white hover:text-indigo-600">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
