                                ...
                                <t:base title="Checkout - IoT Bay" description="Secure checkout and order review">
                                    <main class="py-12">
                                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
                                            ...
                                            <nav aria-label="Breadcrumb">
                                                <ol class="flex flex-wrap items-center gap-2 text-sm text-neutral-600">
                                                    <li><a href="${pageContext.request.contextPath}/"
                                                            class="hover:text-brand-primary">Home</a></li>
                                                    <li aria-hidden="true">/</li>
                                                    <li><a href="${pageContext.request.contextPath}/cart.jsp"
                                                            class="hover:text-brand-primary">Cart</a></li>
                                                    <li aria-hidden="true">/</li>
                                            ...
                                            <section
                                                class="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,360px)] xl:grid-cols-[minmax(0,1fr)_minmax(0,400px)]">
                                                <div class="space-y-4">
                                                    <h1 class="text-display-l font-bold text-neutral-900 leading-tight">
                                                        Secure checkout</h1>
                                                    <p class="text-lg text-neutral-600">Review your order and complete
                                                        your purchase</p>
                                                    <div
                                                        class="flex flex-wrap items-center gap-3 text-sm text-neutral-600">
                                                        <span
                                                            class="inline-flex items-center gap-2 rounded-full bg-neutral-100 px-3 py-1 font-medium text-neutral-700">
                                                            <span
                                                        ...
                                                        <span
                                                            class="inline-flex items-center gap-2 rounded-full bg-neutral-100 px-3 py-1 font-medium text-neutral-700">
                                                            <span
                                                                class="inline-flex h-2 w-2 rounded-full bg-brand-secondary"></span>
                                                            Total: &#36;${totalFormatted}
                                                        </span>
                                                    </div>
                                                </div>
                                                <aside
                                                    class="rounded-2xl border border-neutral-200 bg-neutral-50 p-6 space-y-4"
                                                    aria-label="Checkout guidance">
                                                    <div>
                                                        <h2
                                                            class="text-sm font-semibold uppercase tracking-wide text-neutral-700">
                                                            What to expect</h2>
                                                        <p class="mt-2 text-sm text-neutral-600">Complete shipping
                                                            details, select a payment method, and review your order
                                                            before confirming. All information is encrypted and secure.
                                                        </p>
                                                    </div>
                                                    <ul class="space-y-3 text-sm text-neutral-600">
                                                        <li>Your cart items are reserved for 30 minutes during checkout.
                                                        </li>
                                                        <li>Orders over &#36;100 qualify for free shipping
                                                            automatically.</li>
                                                        <li>You'll receive an email confirmation once your order is
                                                            placed.</li>
                                                    </ul>
                                                </aside>
                                            </section>
                                            ...
                                            <div
                                                class="checkout-progress mb-8 bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
                                                <div class="flex items-center justify-between max-w-3xl mx-auto">
                                                    <!-- Step 1: Cart (Completed) -->
                                                    <div
                                                        class="progress-step progress-step--completed flex flex-col items-center flex-1">
                                                        <div
                                                            class="progress-step__circle w-10 h-10 rounded-full bg-success text-white flex items-center justify-center mb-2">
                                                    ...
                                                    <div
                                                        class="progress-step__line flex-1 h-0.5 bg-success mx-2 mt-[-20px]">
                                                    </div>

                                                    <!-- Step 2: Shipping (Current) -->
                                                    <div
                                                        class="progress-step progress-step--active flex flex-col items-center flex-1">
                                                        <div
                                                            class="progress-step__circle w-10 h-10 rounded-full bg-brand-primary text-white flex items-center justify-center mb-2 ring-4 ring-brand-primary-100">
                                                    ...
                                                    <div
                                                        class="progress-step__line flex-1 h-0.5 bg-neutral-200 mx-2 mt-[-20px]">
                                                    </div>

                                                    <!-- Step 3: Payment -->
                                                    <div class="progress-step flex flex-col items-center flex-1">
                                                        <div
                                                            class="progress-step__circle w-10 h-10 rounded-full bg-neutral-200 text-neutral-500 flex items-center justify-center mb-2">
                                                            <span class="text-sm font-bold">3</span>
                                                        </div>
                                                        <div
                                                            class="progress-step__label text-sm font-medium text-neutral-500">
                                                            Payment</div>
                                                        <div
                                                            class="progress-step__status text-xs text-neutral-400 mt-1">
                                                            Upcoming</div>
                                                    </div>
                                                ...
                                                <div class="text-center mt-4 lg:hidden">
                                                    <span class="text-sm font-medium text-neutral-700">Step 2 of
                                                        4</span>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-8">
                                                <!-- Checkout Form -->
                                                    ...
                                                    <form id="checkoutForm"
                                                        ...
                                                        <section
                                                            ...
                                                            <div class="p-6 border-b border-neutral-200">
                                                                <h2
                                                                    class="text-xl font-semibold text-neutral-900 flex items-center gap-3">
                                                                ...
                                                                <p class="mt-2 text-sm text-neutral-600">Enter the
                                                                    delivery address for your order</p>
                                                            </div>
                                                            <div class="p-6">
                                                                <fieldset class="space-y-6">
                                                                    <legend class="sr-only">Shipping address details
                                                                    </legend>

                                                                    <!-- Saved Addresses -->
                                                                    <div>
                                                                        <label for="savedAddress" class="form-label">Use
                                                                            saved address</label>
                                                                        <select id="savedAddress" name="savedAddress"
                                                                            class="form-input"
                                                                            onchange="loadSavedAddress(this.value)"
                                                                            aria-describedby="savedAddress-help">
                                                                            <option value="">Select a saved address...
                                                                            </option>
                                                                    ...
                                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                                        <div class="form-group md:col-span-2">
                                                                            <jsp:include
                                                                                ...
                                                                                <jsp:param name="placeholder"
                                                                                    value="John Doe" />
                                                                                <jsp:param name="required"
                                                                                    value="true" />
                                                                                <jsp:param name="helpText"
                                                                                    value="Enter the recipient's full name" />
                                                                            </jsp:include>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group md:col-span-2">
                                                                            <jsp:include
                                                                                ...
                                                                                <jsp:param name="required"
                                                                                    value="true" />
                                                                                <jsp:param name="helpText"
                                                                                    value="Format: +1 (555) 123-4567" />
                                                                                <jsp:param name="attributes"
                                                                                    value="pattern='[+]?[0-9\\s\\-\\(\\\\)]+' oninput='formatPhoneNumber(this)'" />
                                                                            </jsp:include>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group md:col-span-2">
                                                                            <jsp:include
                                                                                ...
                                                                                <jsp:param name="placeholder"
                                                                                    value="Street address, P.O. box, company name" />
                                                                                <jsp:param name="required"
                                                                                    value="true" />
                                                                                <jsp:param name="helpText"
                                                                                    value="Street address or P.O. box" />
                                                                            </jsp:include>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group md:col-span-2">
                                                                            <jsp:include
                                                                                ...
                                                                                <jsp:param name="placeholder"
                                                                                    value="Apartment, suite, unit, building, floor, etc." />
                                                                                <jsp:param name="helpText"
                                                                                    value="Additional address information" />
                                                                            </jsp:include>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <jsp:include
                                                                                ...
                                                                                <jsp:param name="required"
                                                                                    value="true" />
                                                                                <jsp:param name="helpText"
                                                                                    value="5-digit ZIP code or ZIP+4" />
                                                                                <jsp:param name="attributes"
                                                                                    value="pattern='[0-9]{5}(-[0-9]{4})?'" />
                                                                            </jsp:include>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="country"
                                                                                class="form-label form-label--required">Country</label>
                                                                    ...
                                                                    <!-- Address Options -->
                                                                    <div
                                                                        class="pt-6 border-t border-neutral-200 space-y-3">
                                                                        <label
                                                                            ...
                                                                            <input type="checkbox"
                                                                                ...
                                                                                class="form-checkbox">
                                                                            <span class="text-sm text-neutral-700">Use
                                                                        ...
                                                                        <label
                                                                            ...
                                                                            <input type="checkbox" id="saveAddress"
                                                                                name="saveAddress"
                                                                                class="form-checkbox">
                                                                            <span class="text-sm text-neutral-700">Save
                                                                                this address for future orders</span>
                                                                        </label>
                                                                    </div>
                                                                </fieldset>
                                                            </div>
                                                        ...
                                                        <section
                                                            ...
                                                            <div class="p-6 border-b border-neutral-200">
                                                                <h2 class="text-xl font-semibold text-neutral-900">
                                                                    Shipping method</h2>
                                                                <p class="mt-2 text-sm text-neutral-600">Choose how
                                                                    quickly you'd like to receive your order</p>
                                                            </div>
                                                            <div class="p-6">
                                                                <fieldset class="space-y-4">
                                                                    <legend class="sr-only">Select shipping method
                                                                    </legend>
                                                                    <label
                                                                        class="shipping-option flex items-start gap-4 p-4 border-2 border-brand-primary rounded-lg cursor-pointer bg-brand-primary-50">
                                                                        <input type="radio" name="shippingMethod"
                                                                            value="standard" class="radio__input mt-1"
                                                                            checked>
                                                                        <div class="flex-1">
                                                                            <div
                                                                                class="flex items-center justify-between mb-2">
                                                                                <span
                                                                                    class="font-semibold text-neutral-900">Standard
                                                                                    Shipping</span>
                                                                                <span
                                                                                    class="text-lg font-bold text-brand-primary">$15.00</span>
                                                                            </div>
                                                                            <p class="text-sm text-neutral-600">5-7
                                                                                business days</p>
                                                                        </div>
                                                                    </label>

                                                                    <label
                                                                        class="shipping-option flex items-start gap-4 p-4 border-2 border-neutral-300 rounded-lg cursor-pointer hover:border-brand-primary transition-colors">
                                                                        <input type="radio" name="shippingMethod"
                                                                            value="express" class="radio__input mt-1">
                                                                        <div class="flex-1">
                                                                            <div
                                                                                class="flex items-center justify-between mb-2">
                                                                                <span
                                                                                    class="font-semibold text-neutral-900">Express
                                                                                    Shipping</span>
                                                                                <span
                                                                                    class="text-lg font-bold text-neutral-900">$25.00</span>
                                                                            </div>
                                                                            <p class="text-sm text-neutral-600">2-3
                                                                                business days</p>
                                                                        </div>
                                                                    </label>
                                                                    ...
                                                                    <label
                                                                        class="shipping-option flex items-start gap-4 p-4 border-2 border-neutral-300 rounded-lg cursor-pointer hover:border-brand-primary transition-colors">
                                                                        <input type="radio" name="shippingMethod"
                                                                            value="overnight" class="radio__input mt-1">
                                                                        <div class="flex-1">
                                                                            <div
                                                                                class="flex items-center justify-between mb-2">
                                                                                <span
                                                                                    class="font-semibold text-neutral-900">Overnight</span>
                                                                                <span
                                                                                    class="text-lg font-bold text-neutral-900">$45.00</span>
                                                                            </div>
                                                                            <p class="text-sm text-neutral-600">Next
                                                                                business day</p>
                                                                        </div>
                                                                    </label>
                                                                </fieldset>
                                                        ...
                                                        <section
                                                            ...
                                                            <div class="p-6 border-b border-neutral-200">
                                                                ...
                                                                <p class="mt-2 text-sm text-neutral-600">Select your
                                                                    preferred payment method and enter details</p>
                                                            </div>
                                                            <div class="p-6">
                                                                <div class="space-y-6">
                                                                    <fieldset>
                                                                        <legend
                                                                            class="form-label form-label--required mb-4">
                                                                            Payment method</legend>
                                                                        <div
                                                                            class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                            <label
                                                                                class="payment-option flex flex-col items-center gap-2 p-4 border-2 border-brand-primary rounded-lg cursor-pointer bg-brand-primary-50">
                                                                                <input type="radio" name="paymentMethod"
                                                                                    value="credit" class="radio__input"
                                                                                    checked
                                                                                    onchange="togglePaymentForm('credit')">
                                                                                <svg class="w-8 h-8 text-brand-primary"
                                                                                    fill="currentColor"
                                                                                    viewBox="0 0 20 20"
                                                                                    aria-hidden="true">
                                                                                    <path
                                                                                ...
                                                                                <span
                                                                                    class="font-medium text-neutral-900">Credit/Debit
                                                                                    Card</span>
                                                                            </label>

                                                                            <label
                                                                                class="payment-option flex flex-col items-center gap-2 p-4 border-2 border-neutral-300 rounded-lg cursor-pointer hover:border-brand-primary transition-colors">
                                                                                <input type="radio" name="paymentMethod"
                                                                                    value="paypal" class="radio__input"
                                                                                    onchange="togglePaymentForm('paypal')">
                                                                                <svg class="w-8 h-8 text-blue-600"
                                                                                    fill="currentColor"
                                                                                    viewBox="0 0 20 20"
                                                                                    aria-hidden="true">
                                                                                    <path
                                                                                        d="M6.5 2.5C7.9 2.5 9.8 3.2 9.8 5.5c0 2.3-1.9 3-3.3 3H5L6.5 2.5zM2 17l2-10h4c3.5 0 6 1.5 6 5s-2.5 5-6 5H4L2 17z" />
                                                                                </svg>
                                                                                <span
                                                                                    class="font-medium text-neutral-900">PayPal</span>
                                                                            </label>

                                                                            <label
                                                                                class="payment-option flex flex-col items-center gap-2 p-4 border-2 border-neutral-300 rounded-lg cursor-pointer hover:border-brand-primary transition-colors">
                                                                                <input type="radio" name="paymentMethod"
                                                                                    value="bank" class="radio__input"
                                                                                    onchange="togglePaymentForm('bank')">
                                                                                <svg class="w-8 h-8 text-green-600"
                                                                                    fill="currentColor"
                                                                                    viewBox="0 0 20 20"
                                                                                    aria-hidden="true">
                                                                                    <path
                                                                                        d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm5 3a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                                                                </svg>
                                                                                <span
                                                                    ...
                                                                    <fieldset id="creditCardForm" class="space-y-4">
                                                                        <legend class="sr-only">Credit card details
                                                                        </legend>
                                                                        <div class="form-group">
                                                                            <label for="cardNumber"
                                                                                class="form-label form-label--required">Card
                                                                                Number</label>
                                                                            <div class="relative">
                                                                        ...
                                                                        <div class="grid grid-cols-2 gap-4">
                                                                            <div class="form-group">
                                                                                <label for="expiryDate"
                                                                                    class="form-label form-label--required">Expiry
                                                                                    Date</label>
                                                                                <input type="text" id="expiryDate"
                                                                                    name="expiryDate" class="form-input"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="cvv"
                                                                                    ...
                                                                                    <button type="button"
                                                                                        ...
                                                                                        onclick="showCVVHelp()">
                                                                                        <svg class="w-4 h-4 text-neutral-400 inline"
                                                                                            fill="currentColor"
                                                                                            viewBox="0 0 20 20"
                                                                                            aria-hidden="true">
                                                                                            <path fill-rule="evenodd"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="cardholderName"
                                                                                class="form-label form-label--required">Cardholder
                                                                                Name</label>
                                                                            <input type="text" id="cardholderName"
                                                                                name="cardholderName" class="form-input"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label
                                                                                ...
                                                                                <input type="checkbox" id="saveCard"
                                                                                    ...
                                                                                    class="form-checkbox">
                                                                                <span
                                                                                    class="text-sm text-neutral-700">Save
                                                                    ...
                                                                    <fieldset id="bankForm" class="hidden space-y-4">
                                                                        <legend class="sr-only">Bank transfer details
                                                                        </legend>
                                                                        <div
                                                        ...
                                                        <section
                                                            ...
                                                            <div class="p-6 border-b border-neutral-200">
                                                                ...
                                                                <p class="mt-2 text-sm text-neutral-600">Verify your
                                                                    information before placing your order</p>
                                                            </div>
                                                            <div class="p-6">
                                                                ...
                                                                <div class="mb-6 pb-6 border-b border-neutral-200">
                                                                    ...
                                                                    <div id="shippingAddressReview"
                                                                        class="text-sm text-neutral-600">
                                                                        <p id="reviewFullName">${user.firstName}
                                                                            ${user.lastName}</p>
                                                                        <p id="reviewAddress1">${empty user.addressLine1
                                                                            ? 'Address Line 1' : user.addressLine1}</p>
                                                                        <p id="reviewAddress2">${empty user.addressLine2
                                                                            ? '' : user.addressLine2}</p>
                                                                        <p id="reviewCityState">${empty user.city ?
                                                                            'City' : user.city}, ${empty user.state ?
                                                                ...
                                                                <div class="mb-6 pb-6 border-b border-neutral-200">
                                                                    ...
                                                                    <div id="paymentMethodReview"
                                                                        class="text-sm text-neutral-600">
                                                                        <p>Credit/Debit Card ending in ?�••�?<span
                                                                                id="reviewCardLast4">4242</span></p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-6 space-y-3">
                                                                    <label
                                                                        ...
                                                                        <input type="checkbox" id="agreeTerms"
                                                                            name="agreeTerms" class="form-checkbox mt-1"
                                                                            required>
                                                                        <span class="text-sm text-neutral-700">
                                                                            I agree to the <a href="#"
                                                                                class="text-brand-primary hover:underline">Terms
                                                                                & Conditions</a> and <a href="#"
                                                                                class="text-brand-primary hover:underline">Privacy
                                                                                Policy</a>
                                                                        </span>
                                                                    </label>
                                                                    <label
                                                                        ...
                                                                        <input type="checkbox" id="agreePrivacy"
                                                                            name="agreePrivacy"
                                                                            class="form-checkbox mt-1" required>
                                                                        <span class="text-sm text-neutral-700">
                                                ...
                                                <aside class="lg:col-span-1">
                                                    <div class="sticky top-8">
                                                        <div
                                                            class="rounded-2xl border border-neutral-200 bg-white shadow-sm">
                                                            <div class="p-6 border-b border-neutral-200">
                                                                <h2 class="text-xl font-semibold text-neutral-900">Order
                                                                    summary</h2>
                                                            </div>
                                                            <div class="p-6 space-y-4">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${not empty cartItems}">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="flex-1 min-w-0">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                class="text-xs text-neutral-600">Qty:
                                                                                                ${item.quantity}</span>
                                                                                            <span
                                                                        ...
                                                                        <!-- Price Breakdown -->
                                                                        <dl class="border-t border-neutral-200 pt-4 space-y-3"
                                                                            aria-label="Order totals">
                                                                            <div class="flex justify-between text-sm">
                                                                                <dt class="text-neutral-600">Subtotal (
                                                                                    <c:out value="${itemCount}" />
                                                                                    items)
                                                                                </dt>
                                                                                <dd
                                                                                    class="font-medium text-neutral-900">
                                                                                    &#36;${subtotalFormatted}</dd>
                                                                            </div>
                                                                            <div class="flex justify-between text-sm">
                                                                                <dt class="text-neutral-600">Shipping
                                                                                </dt>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <dt
                                                                                        class="text-lg font-semibold text-neutral-900">
                                                                                        Total</dt>
                                                                                    <dd class="text-2xl font-bold text-brand-primary"
                                                                                        id="orderTotal">
                                                                                        &#36;${totalFormatted}
                                                                                    </dd>
                                                                                </div>
                                                                        ...
                                                                        <div class="border-t border-neutral-200 pt-4">
                                                                            <div class="flex items-center gap-2 mb-3">
                                                                                ...
                                                                                <span
                                                                                    class="text-sm font-medium text-neutral-700">SSL
                                                                                    Encrypted</span>
                                                                            </div>
                                                                            <div class="flex items-center gap-2 mb-3">
                                                                                <svg class="w-5 h-5 text-success"
                                                                                ...
                                                                                <span
                                                                                    class="text-sm font-medium text-neutral-700">Secure
                                                                                    Checkout</span>
                                                                            </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <p
                                                                                    class="text-sm font-medium text-neutral-900 mb-1">
                                                                                    Estimated Delivery</p>
                                                                                <p class="text-sm text-neutral-600"
                                                                                    id="estimatedDelivery">5-7 business
                                                                                    days</p>
                                                                            </div>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <div class="text-center py-8">
                                                                            ...
                                                                            <p class="text-neutral-600">Your cart is
                                                                                empty</p>
