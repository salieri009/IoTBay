...
<head>
    ...
    <title>Manage Suppliers | IoT Bay - Admin Portal</title>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="<%= contextPath %>/admin/supplier/form" class="btn btn--primary">Add Supplier</a>
                        </div>
                    </div>

                    <!-- Filters -->
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-neutral-200 mb-6">
                        <form action="<%= contextPath %>/admin/supplier/" method="get" class="flex gap-4 items-center">
                                ...
                                <tbody class="divide-y divide-neutral-200">
                                    <c:forEach var="supplier" items="${suppliers}">
                                        <tr class="hover:bg-neutral-50 transition-colors">
                                            <td class="p-4 font-medium text-neutral-900">${supplier.companyName}</td>
                                            <td class="p-4 text-neutral-600">${supplier.contactName}</td>
                                            <td class="p-4 text-neutral-600">${supplier.email}</td>
                                            <td class="p-4 text-neutral-600">${supplier.phoneNumber}</td>
                                            <td class="p-4">
                                            ...
                                            <td class="p-4">
                                                <div class="flex items-center gap-2">
                                                    <a href="<%= contextPath %>/admin/supplier/view/${supplier.id}" class="text-brand-primary hover:text-brand-secondary font-medium text-sm">View</a>
                                                    <a href="<%= contextPath %>/admin/supplier/edit/${supplier.id}" class="text-neutral-600 hover:text-neutral-900 font-medium text-sm">Edit</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
