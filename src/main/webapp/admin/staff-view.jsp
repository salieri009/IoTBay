...
<t:admin-base title="Staff: <%= staffMember.getFirstName() %> <%= staffMember.getLastName() %> | IoT Bay" activeNav="users">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex items-center justify-between">
                    <h1 class="text-display-md text-neutral-900">
                        Staff <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">#<%= staffMember.getId() %></span>
                    </h1>
            ...
            <div class="max-w-3xl mx-auto space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-red-200 p-6">
                    ...
                    <form action="<c:url value='/admin/staff/delete'/>" method="post"
                        ...
                        <input type="hidden" name="user_id" value="<%= staffMember.getId() %>">
