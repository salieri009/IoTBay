...
<%
    ...
    if (products == null || category == null) {
        ...
        response.sendRedirect(contextPath + "/category/smarthome");
        return;
    }
...
<t:base title="Smart Home Solutions - IoT Bay" description="Smart home automation, security, and energy management.">
    ...
    <main class="container py-12">
        ...
        <section id="products" class="py-8">
            <div class="container">
                ...
                <div class="mb-8">
                    <h2 class="text-display-sm font-bold text-neutral-900 mb-2">Smart Home Products</h2>
                    <p class="text-lg text-neutral-600">Transform your home with our comprehensive range of smart home devices and automation solutions</p>
                </div>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <div class="empty-state text-center py-16">
                            ...
                            <h3 class="text-2xl font-bold text-neutral-900 mb-4">No smart home products found</h3>
                            <p class="text-lg text-neutral-600 mb-8 max-w-md mx-auto">
                                <c:choose>
                                    <c:when test="${param.search != null && !empty param.search}">
                                        We couldn't find any smart home products matching "${param.search}". Try adjusting your search terms.
                                    </c:when>
                                    <c:otherwise>
                                        There are no smart home products available at this time. Please check back later.
                                    </c:otherwise>
                                </c:choose>
                            </p>
