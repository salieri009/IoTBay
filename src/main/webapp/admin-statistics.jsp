                        ...
                        <nav class="py-4 bg-neutral-100">
                            <div class="l-container">
                                <div class="flex items-center gap-2 text-sm">
                                    <a href="<c:url value='/'/>"
                                        class="text-neutral-600 hover:text-brand-primary">Home</a>
                                    ...
                                    <a href="<c:url value='/admin-dashboard'/>"
                                        class="text-neutral-600 hover:text-brand-primary">Admin Dashboard</a>
                                    <svg class="w-4 h-4 text-neutral-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
                                            clip-rule="evenodd"></path>
                            ...
                            <div class="l-container">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-blue-100">Comprehensive insights and performance metrics for IoT
                                            Bay platform</p>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                                    ...
                                    <div class="card bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                                        <div class="card__body text-center">
                                            ...
                                            <div class="text-lg font-semibold text-neutral-900 mb-1">Total Customers
                                            </div>
                                            <p class="text-sm text-neutral-600">Across 52 countries</p>
                                            <div class="mt-3 text-xs text-green-600 font-medium">↑ +12.5% from last
                                                month</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                                        <div class="card__body text-center">
                                            ...
                                            <div class="mt-3 text-xs text-green-600 font-medium">↑ +8.3% from last month
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                                        <div class="card__body text-center">
                                            ...
                                            <div class="mt-3 text-xs text-green-600 font-medium">↑ +0.1% from last month
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                                        <div class="card__body text-center">
                                            ...
                                            <div class="text-lg font-semibold text-neutral-900 mb-1">Support Available
                                            </div>
                                            <p class="text-sm text-neutral-600">Average response: 2.3hrs</p>
                                            <div class="mt-3 text-xs text-green-600 font-medium">↑ Response time
                                                improved</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card__body">
                                            <div class="space-y-4">
                                                <div
                                                    class="flex justify-between items-center py-3 border-b border-neutral-200">
