...
<body class="antialiased bg-gray-50 text-gray-900 min-h-screen flex flex-col">
    ...
    <section class="hero-section relative overflow-hidden">
        ...
        <div class="container relative z-10 py-20">
            <div class="max-w-4xl mx-auto text-center">
                <h1 class="heading-1 text-gray-900 mb-6">
                    About <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">IoT Bay</span>
                </h1>
                <p class="body-large text-gray-600 mb-8 max-w-2xl mx-auto">
                ...
                <div class="flex flex-wrap gap-4 justify-center">
                    ...
                    <a href="#our-team" class="btn btn-secondary btn-lg">
                        Meet the Team
                    </a>
                </div>
            </div>
    ...
    <!-- Our Story Section -->
    <section id="our-story" class="section py-20">
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    ...
                    <p class="body-base text-gray-600 mb-6">
                    ...
                    <p class="body-base text-gray-600 mb-8">
                ...
                <div class="relative">
                    <div class="aspect-square rounded-2xl bg-gradient-to-br from-blue-100 to-purple-100 p-8">
                    ...
                    <div class="absolute -bottom-6 -right-6 w-24 h-24 bg-yellow-400 rounded-full flex items-center justify-center shadow-lg">
    ...
    <section class="section-dark py-20">
        <div class="container">
            <div class="text-center mb-16">
                ...
                <p class="body-large text-gray-300 max-w-3xl mx-auto">
    ...
    <section class="section py-20">
        <div class="container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <!-- Quality -->
                <div class="card hover-lift text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
    ...
    <!-- Team Section -->
    <section id="our-team" class="section-dark py-20">
        <div class="container">
            <div class="text-center mb-16">
                <h2 class="heading-2 text-white mb-4">
                    Meet Our Team
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Team Member 1 -->
                <div class="card card-tech text-center">
                    ...
                    <p class="text-blue-400 mb-4">CEO & Founder</p>
                ...
                <div class="card card-tech text-center">
                    ...
                    <p class="text-green-400 mb-4">Chief Technology Officer</p>
                    <p class="text-gray-300 text-sm">
                ...
                <!-- Team Member 3 -->
                <div class="card card-tech text-center">
                    <div class="w-32 h-32 bg-gradient-to-br from-pink-400 to-rose-500 rounded-full mx-auto mb-6 flex items-center justify-center">
                    ...
                    <p class="text-pink-400 mb-4">Head of Sales</p>
                    <p class="text-gray-300 text-sm">
                ...
                <div class="card card-tech text-center">
                    ...
                    <p class="text-yellow-400 mb-4">Head of Engineering</p>
                    <p class="text-gray-300 text-sm">
                ...
                <!-- Team Member 5 -->
                <div class="card card-tech text-center">
                    <div class="w-32 h-32 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full mx-auto mb-6 flex items-center justify-center">
                        <img src="<%= contextPath %>/images/welcome.png" 
                             alt="Lisa Thompson - Customer Success Manager" 
                             class="w-28 h-28 rounded-full object-cover">
                    </div>
                    <h3 class="text-xl font-semibold text-white mb-2">Lisa Thompson</h3>
                    <p class="text-indigo-400 mb-4">Customer Success Manager</p>
                    <p class="text-gray-300 text-sm">
                ...
                <div class="card card-tech text-center">
                    ...
                    <p class="text-purple-400 mb-4">DevOps Engineer</p>
                    <p class="text-gray-300 text-sm">
    ...
    <!-- CTA Section -->
    <section class="section py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div class="container">
            <div class="text-center">
                <h2 class="heading-2 text-white mb-4">
                    Ready to Transform Your World with IoT?
                </h2>
                <p class="body-large text-blue-100 mb-8">
