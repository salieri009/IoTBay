                            ...
                            <div class="w-full max-w-[440px]">
                                <div class="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6 md:p-10">
                                    <div class="text-center mb-8">
                                        <h1 class="text-2xl md:text-3xl font-bold text-neutral-900 mb-2">Welcome back
                                        </h1>
                                    ...
                                    <form class="space-y-6" method="post"
                                        action="${pageContext.request.contextPath}/api/login" id="loginForm"
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="email" id="email" name="email" required autocomplete="email"
                                                placeholder="your.email@example.com" aria-describedby="email-help"
                                    ...
                                    <div class="mt-8 pt-6 border-t border-neutral-200 text-center">
                                        <p class="text-neutral-600">
                                            ...
                                            <a href="${pageContext.request.contextPath}/register.jsp"
                                                class="font-medium text-brand-primary hover:text-brand-primary-700 transition-colors">
                                                Create account
                                            </a>
                                        </p>
                                    </div>
                                ...
                                <div class="mt-8 text-center text-sm text-neutral-500">
                                    ...
                                    <div class="mt-2 space-x-4">
                                        ...
                                        <a href="#" class="hover:text-neutral-900 transition-colors">Terms of
                                            Service</a>
                                    </div>
                                </div>
                            </div>
