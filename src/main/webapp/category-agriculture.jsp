                        ...
                        <% // Defensive coding: Initialize empty collections instead of redirecting to prevent infinite
                            loop List<Product> products = (List<Product>) request.getAttribute("products");
                                ...
                                products = new ArrayList<>();
                                    ...
                                    category = new model.Category(0, "Agriculture", "Smart Agriculture Solutions");
                                    }
                                    ...
                                    <t:base title="Smart Agriculture Solutions - IoT Bay"
                                        description="Precision agriculture IoT solutions for crop/irrigation/livestock.">
                                            ...
                                            <div class="container">
                                                <div class="hero__content">
                                                    ...
                                                    <p class="hero__subtitle">
                                                        Transform traditional farming with precision agriculture IoT
                                                        technology. Monitor soil conditions,
                                                        optimize irrigation, track livestock, and maximize crop yields
                                                ...
                                                <div class="hero__image">
                                                    <img src="${pageContext.request.contextPath}/images/agriculture-hero.jpg"
                                                        alt="Smart Agriculture Technology" class="hero__image"
                                        ...
                                        <main class="container py-12">
                                            ...
                                            <section id="benefits" class="mb-16">
                                                <div class="text-center mb-12">
                                                    <h2 class="text-display-sm font-bold text-neutral-900 mb-4">
                                                        Precision Agriculture Benefits</h2>
                                                    <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                                                        Harness the power of IoT to create sustainable, efficient, and
                                                        profitable farming operations that adapt to changing conditions
                                                        in real-time.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">35%
                                                            Higher Yields</h3>
                                                        <p class="text-neutral-600 text-sm">Optimize growing conditions
                                                            and resource allocation for maximum crop productivity</p>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">50%
                                                            Water Savings</h3>
                                                        <p class="text-neutral-600 text-sm">Smart irrigation systems
                                                            reduce water waste while maintaining optimal soil moisture
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">40% Cost
                                                            Reduction</h3>
                                                        <p class="text-neutral-600 text-sm">Lower operational costs
                                                            through automated monitoring and precise resource management
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h3 class="text-xl font-semibold text-neutral-900 mb-2">95%
                                                            Early Detection</h3>
                                                        <p class="text-neutral-600 text-sm">Identify crop diseases and
                                                            pest issues before they spread across the entire field</p>
                                                    </div>
                                                </div>
                                            </section>
                                            ...
                                            <section class="mb-16">
                                                <div class="text-center mb-12">
                                                    <h2 class="text-display-sm font-bold text-neutral-900 mb-4">
                                                        Comprehensive Smart Farming Solutions</h2>
                                                    <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                                                        From soil monitoring to livestock tracking, our integrated IoT
                                                        ecosystem covers every aspect of modern agriculture.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">Soil
                                                                & Crop Monitoring</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Monitor soil moisture, nutrients, pH levels, and crop
                                                                health in real-time for optimal growing conditions.
                                                            </p>
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">
                                                                Smart Irrigation Systems</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Automated irrigation control based on soil moisture,
                                                                weather forecasts, and crop requirements.
                                                            </p>
                                                            <ul class="space-y-2 text-sm text-neutral-700">
                                                                <li class="flex items-center gap-2">
                                                                    <svg class="w-4 h-4 text-success"
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            <div
                                                                class="w-12 h-12 bg-orange-600 rounded-lg flex items-center justify-center mb-6">
                                                                <svg class="w-6 h-6 text-white" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">
                                                                Livestock Tracking</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Track animal health, location, and behavior patterns
                                                                with wearable IoT devices and smart feeding systems.
                                                            </p>
                                                            <ul class="space-y-2 text-sm text-neutral-700">
                                                                <li class="flex items-center gap-2">
                                                                    <svg class="w-4 h-4 text-success"
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">
                                                                Weather Stations</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Local weather monitoring and forecasting for informed
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            <div
                                                                class="w-12 h-12 bg-teal-600 rounded-lg flex items-center justify-center mb-6">
                                                                <svg class="w-6 h-6 text-white" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">
                                                                Greenhouse Control</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Complete greenhouse automation with climate control,
                                                    ...
                                                    <div class="card card--interactive">
                                                        <div class="card__body">
                                                            ...
                                                            <h3 class="text-xl font-semibold text-neutral-900 mb-3">Farm
                                                                Analytics Platform</h3>
                                                            <p class="text-neutral-600 mb-4">
                                                                Comprehensive dashboard for data visualization,
                                                                reporting, and farm performance analytics.
                                                            </p>
                                                            <ul class="space-y-2 text-sm text-neutral-700">
                                                                <li class="flex items-center gap-2">
                                                                    <svg class="w-4 h-4 text-success"
                                            ...
                                            <section id="products" class="mb-8">
                                                <div
                                                    ...
                                                    <div>
                                                        <h2 class="text-2xl font-bold text-neutral-900 mb-2">Smart
                                                            Agriculture Products</h2>
                                                        <p class="text-neutral-600">Transform your farm with precision
                                                            ...
                                                            <div class="product-grid" id="products-grid">
                                                                <c:forEach var="p" items="${products}">
                                                                    <div class="product-card" data-product-id="${p.id}"
                                                                        ...
                                                                        data-category="agriculture" tabindex="0"
                                                                        ...
                                                                        <div class="product-card__body">
                                                                            <div class="product-card__header">
                                                                                ...
                                                                                <span class="product-card__spec-badge"
                                                                                    title="Communication Protocol">LoRaWAN</span>
                                                                            </div>
                                                            ...
                                                            <div class="empty-state text-center py-16">
                                                                ...
                                                                <p
                                                                    ...
                                                                    <c:choose>
                                                                        ...
                                                                        <c:otherwise>
                                                                            There are no agriculture products available
                                            ...
                                            <section class="mb-16">
                                                <div class="text-center mb-12">
                                                    <h2 class="text-display-sm font-bold text-neutral-900 mb-4">Farmer
                                                        Success Stories</h2>
                                                    <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                                                        Real results from farmers who have embraced smart agriculture
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                                    <div class="card">
                                                        <div class="card__body text-center">
                                                            <div class="text-3xl font-bold text-green-600 mb-2">+45%
                                                            </div>
                                                            <div class="text-lg font-semibold text-neutral-900 mb-2">
                                                                Corn Yield Increase</div>
                                                            <p class="text-sm text-neutral-600">"Smart soil sensors
                                                                helped me optimize fertilizer application and increase
                                                                yields significantly." - John Miller, Iowa</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card__body text-center">
                                                            ...
                                                            <div class="text-lg font-semibold text-neutral-900 mb-2">
                                                                Water Savings</div>
                                                            <p class="text-sm text-neutral-600">"The smart irrigation
                                                                system reduced our water usage while maintaining healthy
                                                                crops." - Maria Rodriguez, California</p>
                                                        </div>
                                                    </div>

                                                    <div class="card">
                                                        <div class="card__body text-center">
                                                            <div class="text-3xl font-bold text-orange-600 mb-2">$50K
                                                            </div>
                                                            <div class="text-lg font-semibold text-neutral-900 mb-2">
                                                                Annual Savings</div>
                                                            <p class="text-sm text-neutral-600">"Precision agriculture
                                                                tools helped us reduce costs and increase profitability
                                                                dramatically." - Tom Wilson, Nebraska</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </section>
                                            ...
                                            <!-- Call to Action -->
                                            <section
                                                class="card bg-gradient-to-r from-green-600 to-emerald-600 text-white">
                                                <div class="card__body text-center py-16">
                                                    <h2 class="text-3xl font-bold mb-4">Ready to Modernize Your Farm?
                                                    </h2>
                                                    <p class="text-xl mb-8 opacity-90">
                                                        Join thousands of farmers who are already benefiting from smart
                                                    ...
                                                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/browse"
                                                            class="btn btn--outline btn--lg border-white text-white hover:bg-white hover:text-green-600">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
