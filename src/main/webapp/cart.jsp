                                    ...
                                    <% // Generate CSRF token for cart API calls String
                                        ...
                                        <%-- Logic refactored to JSTL/EL --%>
                                            ...
                                            <%-- Calculate Totals --%>
                                                ...
                                                <c:set var="freeShippingDelta"
                                                    value="${subtotal >= 50.0 ? 0.0 : 50.0 - subtotal}" />

                                                <%-- Summary Text --%>
                                                    <c:choose>
                                                        <c:when test="${totalItems == 0}">
                                                            <c:set var="cartSummary"
                                                                value="Your cart is currently empty." />
                                                        </c:when>
                                                        <c:otherwise>
                                                            <c:set var="cartSummary"
                                                                value="${totalItems} ${totalItems == 1 ? 'item' : 'items'} in your cart." />
                                                        </c:otherwise>
                                                    </c:choose>
                                                    ...
                                                    <t:base title="Shopping Cart - IoT Bay"
                                                        ...
                                                        <main class="py-12 bg-neutral-50">
                                                            <div class="container mx-auto px-4">
                                                                ...
                                                                <nav aria-label="Breadcrumb" class="mb-8">
                                                                    <ol
                                                                        ...
                                                                        <li><a href="${pageContext.request.contextPath}/"
                                                                                class="hover:text-brand-primary transition-colors">Home</a>
                                                                        </li>
                                                                        <li aria-hidden="true" class="text-neutral-400">
                                                                            /</li>
                                                                ...
                                                                <section class="mb-8">
                                                                    <h1
                                                                        class="text-3xl md:text-4xl font-bold text-neutral-900 leading-tight mb-2">
                                                                        Shopping cart</h1>
                                                                    <p class="text-lg text-neutral-600"
                                                                        id="cart-summary-text">${cartSummary}</p>
                                                                </section>

                                                                <!-- Compatibility Warnings -->
                                                                <div id="compatibility-warnings-container"
                                                                    class="bg-warning-50 border border-warning-200 rounded-lg p-4 mb-8 hidden"
                                                                    role="region" aria-live="polite"
                                                                    aria-label="Compatibility warnings"></div>
                                                                ...
                                                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                                                    ...
                                                                    <div class="lg:col-span-8">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="px-6 py-4 border-b border-neutral-200 bg-neutral-50">
                                                                                <h2
                                                                            ...
                                                                            <div class="p-6">
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${cartItems != null && !empty cartItems}">
                                                                                        <div class="space-y-6">
                                                                                            <c:forEach var="item"
                                                                                                items="${cartItems}">
                                                                                                <jsp:include
                                                                                                    page="/components/molecules/cart-item/cart-item.jsp">
                                                                                                    <jsp:param
                                                                                                        name="itemId"
                                                                                                        value="${item.id}" />
                                                                                                    <jsp:param
                                                                                    ...
                                                                                    <c:otherwise>
                                                                                        ...
                                                                                        <div class="text-center py-12">
                                                                                            <div class="mb-6">
                                                                                                <svg class="w-24 h-24 mx-auto text-neutral-300"
                                                                                                    fill="none"
                                                                                                    stroke="currentColor"
                                                                                                    viewBox="0 0 24 24"
                                                                                                    aria-hidden="true">
                                                                                            ...
                                                                                            <jsp:include
                                                                                                ...
                                                                                                <jsp:param name="href"
                                                                                                    value="${pageContext.request.contextPath}/browse.jsp" />
                                                                                            </jsp:include>
                                                                                        </div>
                                                                                    </c:otherwise>
                                                                                </c:choose>
                                                                    ...
                                                                    <c:if
                                                                        ...
                                                                        <aside class="lg:col-span-4">
                                                                            <div
                                                                                class="bg-white rounded-lg shadow-sm border border-neutral-200 p-6 sticky top-24">
                                                                                <h2
                                                                                    class="text-lg font-semibold text-neutral-900 mb-6">
                                                                                    Order Summary</h2>

                                                                                <div class="space-y-4">
                                                                                    <div
                                                                                        class="flex justify-between items-center text-neutral-600">
                                                                                        <span>Subtotal (<span
                                                                                                data-cart-summary="items-count">
                                                                                                <c:out
                                                                                                    value="${totalItems}" />
                                                                                            </span> items)</span>
                                                                                        <span
                                                                                    ...
                                                                                    <div
                                                                                        class="border-t border-neutral-200 pt-4 mt-4">
                                                                                        <div
                                                                                            class="flex justify-between items-center">
                                                                                            <span
                                                                                                class="text-lg font-bold text-neutral-900">Total</span>
                                                                                            <span
                                                                                ...
                                                                                <div class="mt-8">
                                                                                    <jsp:include
                                                                                        ...
                                                                                        <jsp:param name="size"
                                                                                            value="large" />
                                                                                        <jsp:param name="fullWidth"
                                                                                            value="true" />
                                                                                        <jsp:param name="text"
                                                                                            value="Proceed to Checkout" />
                                                                                        <jsp:param name="href"
                                                                                            value="${pageContext.request.contextPath}/checkout.jsp" />
                                                                                        <jsp:param name="ariaLabel"
                                                                                            value="Proceed to checkout" />
                                                                                    </jsp:include>
                                                                                </div>
