            ...
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                <%@ taglib prefix="t" tagdir="/WEB-INF/tags/layout" %>
                    <%@ page import="java.util.Map" %>
                        ...
                        <t:base title="Categories | IoT Bay"
                            description="Browse IoT device categories - Smart Home, Industrial, Agricultural, and Warehouse">
                            <main>
                                <!-- Hero Section -->
                                <section
                                    ...
                                    <div class="container">
                                        <div class="max-w-3xl mx-auto text-center">
                                            ...
                                            <p class="text-xl text-blue-100 mb-8">
                                                Discover cutting-edge Internet of Things solutions across diverse
                                                industries and applications
                                            </p>
                                            <div class="flex flex-wrap gap-4 justify-center">
                                                <a href="#smart-home" class="btn btn--white btn--lg">Smart Home</a>
                                                <a href="#industrial" class="btn btn--outline-white btn--lg">Industrial
                                                    IoT</a>
                                                <a href="#agriculture"
                                                    class="btn btn--outline-white btn--lg">Agriculture</a>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="text-center mb-12">
                                            ...
                                            <p class="text-lg text-neutral-600 max-w-2xl mx-auto">
                                                From smart home automation to industrial monitoring, find the perfect
                                                IoT solution for your needs
                                            </p>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                            <c:forEach var="category" items="${categories}">
                                                <c:set var="categorySlug"
                                                    value="${fn:toLowerCase(fn:replace(category.name, ' ', '-'))}" />
                                                <c:set var="productCount"
                                                    value="${categoryProductCounts[category.id] != null ? categoryProductCounts[category.id] : 0}" />
                                                <article id="${categorySlug}" class="category-card group">
                                                    <div class="category-card__image">
                                                        ...
                                                        <div class="category-card__overlay">
                                                            <span class="category-card__count">${productCount}+
                                                                Products</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <c:if test="${empty categories}">
                                                ...
                                                <article id="smart-home" class="category-card group">
                                                    ...
                                                    <div class="category-card__content">
                                                        ...
                                                        <p class="category-card__description">
                                                            Transform your living space with intelligent automation,
                                                            security systems,
