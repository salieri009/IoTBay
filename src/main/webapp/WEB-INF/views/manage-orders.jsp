                    ...
                    <%@ page import="model.Order" %>
                        <%@ page import="java.util.List" %>
                            ...
                            <% User user=(User) session.getAttribute("user"); if (user==null ||
                                ...
                                !"admin".equalsIgnoreCase(user.getRole()))) { response.sendRedirect("../../login.jsp");
                                return; } String contextPath=request.getContextPath(); @SuppressWarnings("unchecked")
                                List<Order> orders = (List<Order>) request.getAttribute("orders");
                                    ...
                                    orders = new java.util.ArrayList<>();
                                        ...
                                        <t:base>
                                            <jsp:attribute name="title">Manage Orders | IoT Bay - Admin Portal
                                            </jsp:attribute>
                                                                    ...
                                                                    <table class="w-full text-left border-collapse">
                                                                        <thead>
                                                                            <tr
                                                                                ...
                                                                                <th
                                                                                    class="p-4 font-semibold text-neutral-700">
                                                                                    Order ID</th>
                                                                                <th
                                                                                    class="p-4 font-semibold text-neutral-700">
                                                                                    User ID</th>
                                                                        ...
                                                                        <tbody class="divide-y divide-neutral-200">
                                                                            <c:forEach var="order"
                                                                                ...
                                                                                <tr
                                                                                    ...
                                                                                    <td
                                                                                        class="p-4 font-medium text-neutral-900">
                                                                                        #${order.id}</td>
