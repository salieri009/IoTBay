                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <jsp:include page="/components/atoms/button/button.jsp">
                            <jsp:param name="text" value="Export Products" />
                            <jsp:param name="type" value="secondary" />
                            <jsp:param name="onclick" value="alert('Export feature coming soon')" />
                        </jsp:include>

                        <jsp:include page="/components/atoms/button/button.jsp">
                            <jsp:param name="text" value="Add Product" />
                                ...
                                <div class="card p-6 hover-lift">
                                    ...
                                    <div class="space-y-2 mb-4">
                                        ...
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="font-medium text-neutral-900">${product.stockQuantity}
                                                units</span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-neutral-600">Category
                                                ID:</span>
