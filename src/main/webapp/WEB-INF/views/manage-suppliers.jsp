                    ...
                    <%@ page import="java.util.List" %>
                        <%@ page import="java.util.ArrayList" %>
                            ...
                            <% User user=(User) session.getAttribute("user"); if (user==null ||
                                !"staff".equalsIgnoreCase(user.getRole())) { response.sendRedirect("../../login.jsp");
                                return; } String contextPath=request.getContextPath(); // Mock supplier data
                                List<Object> suppliers = new ArrayList<>();
                                    suppliers.add(new Object[]{"IoT Solutions Inc.", "contact@iotsolutions.com",
                                    "+1-555-0123", "Active", "50 products"});
                                    suppliers.add(new Object[]{"SmartTech Co.", "info@smarttech.com", "+1-555-0124",
                                    "Active", "25 products"});
                                    suppliers.add(new Object[]{"Global Connect", "sales@globalconnect.com",
                                    "+1-555-0125", "Inactive", "15 products"});
                                    %>

                                    <t:base>
                                        <jsp:attribute name="title">Manage Suppliers | IoT Bay - Staff Portal
                                        </jsp:attribute>
                                                                ...
                                                                <table class="w-full">
                                                                    ...
                                                                    <tbody class="divide-y divide-neutral-200">
                                                                        <c:forEach var="supplier"
                                                                            items="<%= suppliers %>" varStatus="status">
