                ...
                <% if (accessLogList !=null) { %>
                    ...
                    <% } %>
                        ...
                        <form method="get" action="<%= request.getContextPath() %>/api/accessLog">
                            ...
                            <input type="date" id="startDate" name="startDate" value="<%= request.getParameter("
                                startDate") !=null ? request.getParameter("startDate") : "" %>"/>
                            <label for="endDate">End Date:</label>
                            <input type="date" id="endDate" name="endDate" value="<%= request.getParameter(" endDate")
                                !=null ? request.getParameter("endDate") : "" %>"/>
                        ...
                        <table>
                            ...
                            <% if (accessLogList !=null && !accessLogList.isEmpty()) { int idx=1; for (AccessLog log :
                                accessLogList) { %>
                                <tr>
                                    <td>
                                        <%= idx++ %>
                                    ...
                                    <td>
                                        <% LocalDateTime ts=log.getTimestamp(); String formattedTs="" ; try {
                                            formattedTs=ts !=null ? ts.format(dtf) : "" ; } catch(Exception e) {
