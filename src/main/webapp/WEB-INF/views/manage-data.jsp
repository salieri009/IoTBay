        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            <%@ page import="model.User" %>
                ...
                <% User user=(User) session.getAttribute("user"); if (user==null ||
                    !"staff".equalsIgnoreCase(user.getRole())) { response.sendRedirect(request.getContextPath()
                    + "/login.jsp" ); return; } %>
                                    ...
                                    <div class="max-w-6xl mx-auto">
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            <div class="card p-6">
                                                ...
                                                <p class="text-neutral-600 mb-4">Create system backups and restore data
                                                </p>
                                            ...
                                            <div class="card p-6">
                                                ...
                                                <h3 class="text-lg font-semibold text-neutral-900 mb-2">Data Integrity
                                                </h3>
