        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            <%@ page import="model.User" %>
                ...
                <% User user=(User) session.getAttribute("user"); if (user==null ||
                    ...
                    <t:base title="Data Management | IoT Bay">
                        <main class="flex-1">
                                ...
                                <div class="container">
                                    <div class="max-w-6xl mx-auto">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                                            ...
                                            <div class="bg-white p-6 rounded-xl shadow-sm border border-neutral-200">
                                                <div class="text-sm text-neutral-500 font-medium mb-1">Total Products
                                                </div>
                                                <div class="text-3xl font-bold text-neutral-900">${totalProducts}</div>
                                            </div>
                                            <div class="bg-white p-6 rounded-xl shadow-sm border border-neutral-200">
                                                <div class="text-sm text-neutral-500 font-medium mb-1">Total Orders
                                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div
                                                    class="p-4 border border-neutral-200 rounded-lg hover:border-brand-primary transition-colors">
                                                    <h3 class="font-semibold text-neutral-900 mb-2">User Data</h3>
                                                    <p class="text-sm text-neutral-600 mb-4">Export all registered user
                                                        accounts and details.</p>
                                                    <a href="${pageContext.request.contextPath}/api/dataManagement/exportUsers"
                                                        class="btn btn--secondary w-full justify-center">Export
                                                        Users</a>
                                                </div>
                                                <div
                                                    class="p-4 border border-neutral-200 rounded-lg hover:border-brand-primary transition-colors">
                                                    <h3 class="font-semibold text-neutral-900 mb-2">Product Catalog</h3>
                                                    <p class="text-sm text-neutral-600 mb-4">Export full product
                                                        inventory and details.</p>
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-sm text-neutral-600 mb-4">Export all customer orders
                                                        and transactions.</p>
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-sm text-neutral-600 mb-4">Export system access and
                                                        security logs.</p>
                                                    <a href="${pageContext.request.contextPath}/api/dataManagement/exportAccessLogs"
                                                        class="btn btn--secondary w-full justify-center">Export Logs</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
