                        ...
                        <%@ page import="java.util.List" %>
                            <%@ page import="java.util.ArrayList" %>
                                ...
                                <% User user=(User) session.getAttribute("user"); if (user==null ||
                                    ...
                                    users from request attribute List<User> users = (List<User>)
                                        ...
                                        users = new ArrayList<>();
                                            ...
                                            <t:base>
                                                <jsp:attribute name="title">Manage Users | IoT Bay - Staff Portal
                                                </jsp:attribute>
                                                                ...
                                                                <div class="flex items-center justify-between">
                                                                    ...
                                                                    <div class="flex items-center gap-3">
                                                                        ...
                                                                        <jsp:include
                                                                            ...
                                                                            <jsp:param name="href"
                                                                                value="${pageContext.request.contextPath}/api/manage/users/form" />
                                                                        </jsp:include>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="container">
                                                            <div class="max-w-6xl mx-auto">
                                                                ...
                                                                <div class="card overflow-hidden">
                                                                    ...
                                                                    <!-- Pagination -->
                                                                    <jsp:include
                                                                        page="/components/molecules/pagination/pagination.jsp">
