          ...
          <div class="relative z-[100]">
            ...
            <div class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl py-2 ring-1 ring-neutral-200 focus:outline-none hidden z-[9999]" 
              ...
              <div class="py-1">
                ...
                <c:if test="${isStaff}">
                  <a href="<c:url value='/admin-dashboard' />" class="flex items-center gap-3 px-4 py-2.5 text-sm text-neutral-700 hover:bg-brand-primary/5 hover:text-brand-primary transition-colors" role="menuitem">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
