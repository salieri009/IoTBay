...
<footer class="footer bg-neutral-900 text-neutral-300 mt-auto">
    <div class="container">
        ...
        <div class="footer__content py-12">
            ...
            <!-- Company Info - Left aligned for brand recognition -->
            <div class="footer__brand mb-8">
            ...
            <!-- Links Grid - Left aligned for easy scanning -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <!-- Newsletter - Centered for emphasis -->
                <div class="footer__section md:col-span-2 lg:col-span-2 text-center">
                    ...
                    <form class="footer__newsletter max-w-md mx-auto" action="${pageContext.request.contextPath}/newsletter" method="post">
                        <div class="flex">
                            <input 
                                type="email" 
                                name="email" 
                    ...
                    <!-- Contact Info - Centered for newsletter section -->
