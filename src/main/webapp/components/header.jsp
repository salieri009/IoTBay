...
<header class="nav">
    <div class="container">
        ...
        <nav class="nav__menu">
            ...
            <a href="<c:url value='/contact.jsp' />" class="nav__link">Contact</a>
            <% if (user == null) { %>
                <!-- Sign Up prominently displayed in main navigation for guests -->
                <a href="<c:url value='/register.jsp' />" class="nav__link nav__link--highlight">Sign Up</a>
            <% } %>
        </nav>
        ...
        <div class="nav__actions">
            <% if (user != null) { %>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown__menu" id="userMenuDropdown">
                        <a href="<c:url value='/Profiles.jsp' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path>
                            </svg>
                            Profile
                        </a>
                        <a href="<c:url value='/orders.jsp' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"></path>
                            </svg>
                            Orders
                        </a>
                        <a href="<c:url value='/cart.jsp' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <% if (isStaff) { %>
                        <a href="<c:url value='/reports' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"></path>
                            </svg>
                            Reports & Analytics
                        </a>
                        <a href="<c:url value='/manage/users' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="<c:url value='/manage/products' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                            </svg>
                            Manage Products
                        </a>
                        <a href="<c:url value='/manage/suppliers' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                            Manage Suppliers
                        </a>
                        <a href="<c:url value='/manage/data' />" class="dropdown__item">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="<c:url value='/logout.jsp' />" class="dropdown__item dropdown__item--danger">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            ...
            <% } else { %>
                ...
                <div class="flex gap-2">
                    <a href="<c:url value='/login.jsp' />" class="btn btn--primary btn--sm">Sign In</a>
                </div>
            <% } %>
            ...
            <div class="flex items-center gap-3 ml-4">
                ...
                <a href="<c:url value='/cart.jsp' />" class="btn btn--ghost btn--icon relative" aria-label="Shopping cart">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path>
                    </svg>
