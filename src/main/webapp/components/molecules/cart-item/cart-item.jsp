<%--============================================Molecule: Cart
    Item============================================Description: A card component representing a single item in the
    shopping cart. Includes product image, details, price, quantity controls, and remove button. Parameters: - itemId:
    The unique ID of the cart item - productId: The unique ID of the product - productName: Name of the product -
    productDescription: Description of the product - productImageUrl: URL of the product image - price: Unit price of
    the product - quantity: Current quantity in cart - maxQuantity: Maximum available stock Usage: <jsp:include
            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                    ...
                    <div class="cart-item bg-white border border-neutral-200 rounded-lg p-4 transition-shadow hover:shadow-sm"
                        data-item-id="${param.itemId}" data-product-id="${param.productId}" role="article"
                        aria-label="Cart item: ${fn:escapeXml(param.productName)}">
                            ...
                            <div class="flex-1 min-w-0 flex flex-col justify-between">
                                <div class="flex items-start justify-between gap-4 mb-2">
                                    <div class="flex-1 min-w-0">
                                        <h3
                                            class="cart-item-name text-lg font-semibold text-neutral-900 mb-1 leading-tight">
                                            <a href="${pageContext.request.contextPath}/product?productId=${param.productId}"
                                    ...
                                    <button
                                        ...
                                        aria-label="Remove ${fn:escapeXml(param.productName)} from cart"
                                        title="Remove item">
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-neutral-100 mt-auto">
                                    <div class="quantity-controls flex items-center gap-3">
                                        <label for="quantity-${param.itemId}" class="sr-only">Quantity for
                                            ${fn:escapeXml(param.productName)}</label>
                                        ...
                                        <input type="number" id="quantity-${param.itemId}" value="${param.quantity}"
                                            min="1" max="${param.maxQuantity}"
