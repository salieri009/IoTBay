  ...
  <div class="group relative bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-neutral-200 overflow-hidden flex flex-col h-full">
    ...
    <div class="p-4 flex-1 flex flex-col">
      ...
      <div class="mt-auto flex items-end justify-between">
        ...
        <div class="flex items-center gap-1 text-yellow-400 text-sm" aria-label="Rated 4.5 out of 5 stars">
            ...
            <span class="text-neutral-400 font-medium ml-1" aria-hidden="true">4.5</span>
        </div>
      </div>
    </div>
