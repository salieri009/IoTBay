...
<c:if test="${product != null}">
  <div class="group relative bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-neutral-200 hover:border-neutral-300 overflow-hidden flex flex-col h-full">
    <%-- Product Image --%>
    ...
    <div class="p-4 flex-1 flex flex-col">
      <p class="text-xs text-neutral-600 mb-1 uppercase tracking-wider font-semibold">${product.category}</p>
      ...
      <div class="mt-auto flex items-end justify-between">
        ...
        <div class="flex items-center gap-1 text-amber-500 text-sm" aria-label="Rated 4.5 out of 5 stars">
            <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20" aria-hidden="true"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
            <span class="text-neutral-700 font-semibold ml-1" aria-hidden="true">4.5</span>
        </div>
      </div>
    </div>
