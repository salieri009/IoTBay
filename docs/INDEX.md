...
Start here if you're coding features, fixing bugs, or integrating components:
1. [**New Developer Guide**](./NEW_DEVELOPER_GUIDE.md) - 15-min setup ⭐
2. [**Quick Reference**](./QUICK_REFERENCE.md) - Common tasks & workflows
3. [**Tech Stack Overview**](./1_getting-started/TECH_STACK.md) - Technologies used
4. [**Backend Developer Guide**](./4_development/BACKEND_GUIDE.md) - Java/Servlet patterns
5. [**Frontend Developer Guide**](./4_development/FRONTEND_GUIDE.md) - JSP/TypeScript patterns
6. [**Git Workflow**](./4_development/GIT_WORKFLOW.md) - Branching strategy
7. [**Code Style Guide**](./4_development/CODE_STYLE.md) - Coding standards

### 🏗️ For Architects & Tech Leads
Start here for system design, performance, and technical decisions:
1. [**Architecture Guide**](./ARCHITECTURE_GUIDE.md) - Complete overview ⭐
2. [**Component Architecture**](./2_architecture/COMPONENT_ARCHITECTURE.md) - UI component design
3. [**Database Design**](./2_architecture/DATABASE_DESIGN.md) - Schema & relationships
4. [**API Design**](./2_architecture/API_DESIGN.md) - API structure & patterns
5. [**Security Architecture**](./2_architecture/SECURITY_ARCHITECTURE.md) - Security design
6. [**Design System**](./2_architecture/DESIGN_SYSTEM.md) - Visual design standards

### 🧪 For QA & Testers
Start here for testing strategies, error prevention, and acceptance criteria:
1. [**Testing Guide**](./TESTING_GUIDE.md) - Overview & quick start ⭐
2. [**Test Strategy**](./5_testing/TEST_STRATEGY.md) - Comprehensive testing approach
3. [**Error Prevention**](./5_testing/ERROR_PREVENTION.md) - Prevent 403/404/500 errors
4. [**Acceptance Criteria**](./3_requirements/acceptance-criteria/) - Feature AC by FR
5. [**Accessibility Testing**](./5_testing/ACCESSIBILITY_TESTING.md) - WCAG 2.1 AA compliance

### 📋 For Product Managers & Stakeholders
Start here for features, requirements, and project status:
1. [**Project Overview**](./1_getting-started/PROJECT_OVERVIEW.md) - What is IoT Bay? ⭐
2. [**Features List**](./3_requirements/FEATURES.md) - Complete feature inventory
3. [**User Stories**](./3_requirements/USER_STORIES.md) - User-centric descriptions
4. [**Project Roadmap**](./6_planning/PROJECT_ROADMAP.md) - Future releases
5. [**Reports**](./7_reports/) - Status & metrics
...
**Purpose**: Onboarding, environment setup, technology overview

| Document | Audience | Purpose |
|----------|----------|---------|
| [**QUICKSTART.md**](./1_getting-started/QUICKSTART.md) | Everyone | 5-minute startup guide |
| [**PROJECT_OVERVIEW.md**](./1_getting-started/PROJECT_OVERVIEW.md) | PMs, Architects | What is IoT Bay? Scope & goals |
| [**SETUP_GUIDE.md**](./1_getting-started/SETUP_GUIDE.md) | Developers | Local environment configuration |
...
| Document | Audience | Purpose |
|----------|----------|---------|
| [**BACKEND_GUIDE.md**](./4_development/BACKEND_GUIDE.md) | Backend Developers | Java/Servlet/DAO patterns |
| [**FRONTEND_GUIDE.md**](./4_development/FRONTEND_GUIDE.md) | Frontend Developers | JSP/TypeScript/CSS patterns |
...
### 📊 7. Reports (2 documents)
**Purpose**: Status updates, metrics, session summaries

| Document | Audience | Purpose |
|----------|----------|---------|
| [**2025/**](./7_reports/2025/) | Stakeholders, PMs | 2025 progress reports |
| [**README.md**](./7_reports/README.md) | Everyone | Section overview |

### 📦 8. Archive (Reference Only)
**Purpose**: Historical documentation, deprecated guides
...
### Getting Help
- **"How do I get started?"** → [New Developer Guide](./NEW_DEVELOPER_GUIDE.md)
- **"What technologies are used?"** → [Tech Stack](./1_getting-started/TECH_STACK.md)
- **"Where's the code style guide?"** → [Code Style](./4_development/CODE_STYLE.md)
- **"How do I debug a backend issue?"** → [Backend Guide - Debugging](./4_development/BACKEND_GUIDE.md#troubleshooting)
- **"What are the API endpoints?"** → [API Reference](./3_requirements/API_REFERENCE.md)

### Understanding the System
- **"What does IoT Bay do?"** → [Project Overview](./1_getting-started/PROJECT_OVERVIEW.md)
- **"How is the frontend structured?"** → [Component Architecture](./2_architecture/COMPONENT_ARCHITECTURE.md)
- **"What's the database schema?"** → [Database Design](./2_architecture/DATABASE_DESIGN.md)
- **"How are APIs organized?"** → [API Design](./2_architecture/API_DESIGN.md)
- **"What are the security requirements?"** → [Security Architecture](./2_architecture/SECURITY_ARCHITECTURE.md)

### Contributing & Collaboration
- **"How do I contribute?"** → [Contributing Guide](./4_development/CONTRIBUTING.md)
- **"What's the Git workflow?"** → [Git Workflow](./4_development/GIT_WORKFLOW.md)
- **"How do I set up my environment?"** → [Setup Guide](./1_getting-started/SETUP_GUIDE.md)
- **"What's the commit message format?"** → [Contributing - Commit Convention](./4_development/CONTRIBUTING.md#commit-messages)

### Testing & Quality
- **"How do I test my changes?"** → [Test Strategy](./5_testing/TEST_STRATEGY.md)
- **"What are acceptance criteria for Feature X?"** → [Acceptance Criteria](./3_requirements/acceptance-criteria/)
...
- **"What features are implemented?"** → [Features List](./3_requirements/FEATURES.md)
- **"What's the user story for Feature X?"** → [User Stories](./3_requirements/USER_STORIES.md)
- **"When is Feature X coming?"** → [Project Roadmap](./6_planning/PROJECT_ROADMAP.md)
- **"What was the original assignment?"** → [ISD Assignment PDF](./3_requirements/reference/41025_ISD_Assignment_2_Autumn_2025.pdf)
...
**Documentation Structure**: Hierarchical (8 sections)  
**Current Version**: 1.0.0  
**Aligned With**: IoT Bay v1.0.0  
**Last Reviewed**: December 3, 2025  
**Maintenance Cadence**: Per sprint + on-demand updates  

---

## 🔄 Navigation Tips

1. **Bookmark this index** - It's your master reference
2. **Use Ctrl+F** to search this page for topics
3. **Follow role-based guides** at the top for personalized paths
4. **Check "Related Documents"** sections in each doc for context
5. **Report broken links** via GitHub Issues
