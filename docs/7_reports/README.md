...
See [2025/](./2025/) directory for detailed reports.
...
1. **Choose the appropriate directory** (e.g., `2025/`)
2. **Use naming convention**: `YYYY-MM-DD_TYPE_SUMMARY.md`
   - Example: `2025-12-03_SESSION_SUMMARY.md`
...
4. **Update this README** with a table entry
...
- **Planning** → [6_planning/](../6_planning/)
- **Requirements** → [3_requirements/](../3_requirements/)
- **Testing** → [5_testing/](../5_testing/)
- **Project Overview** → [1_getting-started/PROJECT_OVERVIEW.md](../1_getting-started/PROJECT_OVERVIEW.md)
